...
var showTooltip = function showTooltip(element) {
  ...
  popover.style.bottom = "".concat(top + 25, "px");
  popover.style.left = "".concat(left + element.offsetWidth / 2 - popover.offsetWidth / 2, "px");
};
var removeTooltip = function removeTooltip() {
  document.querySelector('.popover').remove();
};
button.addEventListener('click', function (e) {
  var tooltip = document.querySelector('.popover');
  if (!tooltip) {
